...
const BehaviorScript bhvEnemyToad[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    ...
    ANIMATE(6),
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(enemy_toad_init),
    BEGIN_LOOP(),
        CALL_NATIVE(enemy_toad_loop),
    END_LOOP(),
};


const BehaviorScript bhvEnemyBomb[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    ...
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    //SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -400, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    CALL_NATIVE(enemy_bomb_init),
    BEGIN_LOOP(),
        CALL_NATIVE(enemy_bomb_loop),
    END_LOOP(),
};

const BehaviorScript bhvSmallSpawner[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(small_spawner_loop),
    END_LOOP(),
};
const BehaviorScript bhvBigSpawner[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
