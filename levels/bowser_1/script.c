...
const LevelScript level_bowser_1_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        ...
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -1600, 400, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallSpawner),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -300, 400, 2000, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallSpawner),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -300, 400, -1700, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallSpawner),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1600, 400, -900, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallSpawner),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 1600, 400, 1600, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ bhvSmallSpawner),

        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 100, 400, 2000, /*angle*/ 0, 180, 0, /*behParam*/ 0x00000000, /*beh*/ bhvBigSpawner),
