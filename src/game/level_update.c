...
s32 print_time_text(UNUSED s16 arg0, UNUSED s32 arg1) {
    print_text(10, 200, "YOUR TIME");
    //print_text_fmt_int(10, 180, "%d", gTimer/1800);
    print_text_fmt_int(10, 160, "%d", gTimer/30);
    //print_text(80, 180, "MINUTES");
    print_text(80, 160, "SECONDS");
}
