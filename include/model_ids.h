...
// group 12
#define MODEL_BOWSER                      0x164        // bowser_geo
#define MODEL_BOWSER_BOMB_CHILD_OBJ       0x165        // bowser_bomb_geo - Spawns as a chill object in bowser's behavior command, causing an explosion if it touches a bomb
#define MODEL_BOWSER_SMOKE                0x166        // bowser_impact_smoke_geo
#define MODEL_BOWSER_FLAMES               0x167        // bowser_flames_geo
#define MODEL_BOWSER_WAVE                 0x168        // invisible_bowser_accessory_geo
#define MODEL_BOWSER_NO_SHADOW            0x169        // bowser_geo_no_shadow
...
#define MODEL_MINMINE                     0xFE
#define MODEL_PENGUIN                     0x100        // penguin_geo
